...
def init_pair_dataset(cfg, plabel_path=None, source_plabel_path=None, selected=None, centroid=None,
                      wei_path=None, fuse=False, target_selected=None, source_list='none', target_list='none'):
    source_env = cfg[cfg.source]
    target_env = cfg[cfg.target]
    cfg.num_classes=cfg.num_classes
    cfg.source_size = source_env.input_size
    ...
    source_trainloader = data.DataLoader(source_dataset, batch_size=cfg.batch_size, shuffle=False,
                                                          num_workers=cfg.worker, pin_memory=True, drop_last=True)

    target_trainloader = data.DataLoader(target_dataset, batch_size=cfg.batch_size, shuffle=False,
                                                          num_workers=cfg.worker, pin_memory=True, drop_last=True)

    return source_trainloader, target_trainloader, cfg
